...
public class TableConstant {
	...
	static{
		TABLE_BEAN.put("cn.kee.core.entity.User", "user_base");
		TABLE_BEAN.put("cn.kee.core.entity.bo.FeedbackBo", "feedback");
		TABLE_BEAN.put("cn.kee.core.entity.bo.SysUserBo", "sys_user");
		TABLE_BEAN.put("cn.kee.core.entity.bo.BlogArticleBo", "blog_article");
		TABLE_BEAN.put("cn.kee.core.entity.bo.CalendarBo", "xgcalendar");
		TABLE_BEAN.put("cn.kee.core.entity.bo.AlipayEventUser", "coding_event_user");
	}
